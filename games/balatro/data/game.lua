...
function Game:set_language()
    if not self.LANGUAGES then 
        ...
        self.LANGUAGES = {
            ...
            ['de'] = {font = 1, label = "Deutsch", key = 'de', beta = nil, button = "Feedback zur Ãbersetzung", warning = {'Diese Ãbersetzung ist noch im Beta-Stadium. Willst du uns helfen,','sie zu verbessern? Dann klicke bitte auf die Feedback-Taste.', "Zum BestÃ¤tigen erneut klicken"}},
            ...
            -- ['ja'] = {font = 5, label = "æ¥æ¬èª", key = 'ja', beta = nil, button = "ææ¡ãã", warning = {'ãã®ç¿»è¨³ã¯ç¾å¨ãã¼ã¿çã§ããææ¡ããã£ãå ´åã','ãã¿ã³ãã¯ãªãã¯ãã¦ãã ããã', "ããä¸åº¦ã¯ãªãã¯ãã¦ç¢ºèª"}},
            -- ['ko'] = {font = 4, label = "íêµ­ì´", key = 'ko', beta = true, button = "ë²ì­ í¼ëë°±", warning = {'ì´ ì¸ì´ë ìì§ ë² í ë¨ê³ì ììµëë¤. ','ë²ì­ì ëìì£¼ìë ¤ë©´ í¼ëë°± ë²í¼ì ëë¬ì£¼ì¸ì.', "ë¤ì í´ë¦­í´ì íì¸íì¸ì"}},
            ...
            -- ['ru'] = {font = 6, label = "Ð ÑÑÑÐºÐ¸Ð¹", key = 'ru', beta = true, button = "ÐÑÐ·ÑÐ² Ð¾ ÑÐ·ÑÐºÐµ", warning = {'Ð­ÑÐ¾Ñ ÑÐ·ÑÐº Ð²ÑÐµ ÐµÑÐµ Ð½Ð°ÑÐ¾Ð´Ð¸ÑÑÑ Ð² ÐÐµÑÐ°-Ð²ÐµÑÑÐ¸Ð¸. Ð§ÑÐ¾Ð±Ñ Ð¿Ð¾Ð¼Ð¾ÑÑ','Ð½Ð°Ð¼ ÐµÐ³Ð¾ ÑÐ»ÑÑÑÐ¸ÑÑ, Ð¿Ð¾Ð¶Ð°Ð»ÑÐ¹ÑÑÐ°, Ð½Ð°Ð¶Ð¼Ð¸ÑÐµ Ð½Ð° ÐºÐ½Ð¾Ð¿ÐºÑ Ð¾Ð±ÑÐ°ÑÐ½Ð¾Ð¹ ÑÐ²ÑÐ·Ð¸.', "Ð©ÐµÐ»ÐºÐ½Ð¸ÑÐµ ÑÐ½Ð¾Ð²Ð°, ÑÑÐ¾Ð±Ñ Ð¿Ð¾Ð´ÑÐ²ÐµÑÐ´Ð¸ÑÑ"}},
            -- ['zh_CN'] = {font = 2, label = "ç®ä½ä¸­æ", key = 'zh_CN', beta = nil, button = "æè§åé¦", warning = {'è¿ä¸ªè¯­è¨ç®åå°ä¸ºBetaçæ¬ã è¯·å¸®å©æä»¬æ¹åç¿»è¯åè´¨ï¼','ç¹å»âæè§åé¦â æ¥æä¾ä½ çæè§ã', "åæ¬¡ç¹å»ç¡®è®¤"}},
            -- ['zh_TW'] = {font = 3, label = "ç¹é«ä¸­æ", key = 'zh_TW', beta = nil, button = "æè¦åé¥", warning = {'éåèªè¨ç®åå°çºBetaçæ¬ãè«å¹«å©æåæ¹åç¿»è­¯åè³ªï¼','é»æâæè¦åé¥â ä¾æä¾ä½ çæè¦ã', "åæä¸ä¸å³å¯ç¢ºèª"}},
